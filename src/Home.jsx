...
function Home() {
  ...
  <div className="carousel-inner">
    <div className="carousel-item active" data-bs-interval={10000}>
      <img className=".bg-dark.bg-gradient .bg-primary.bg-gradient img" src="https://utouchdesign.com/themes/envato/altroznews/images/news/lifestyle/health5.jpg" className="d-block w-100" alt="..." />
  ...
  <button className="carousel-control-next" type="button" data-bs-target="#carouselExampleDark" data-bs-slide="next">
    ...
    <span className="visually-hidden">Next</span>
        ...
        <div className="col-lg-4 ">
          <div>
        <img className="w-100" src="https://utouchdesign.com/themes/envato/altroznews/images/news/tech/gadget2.jpg" alt="" />
        {/* <p>Samsung gear s3 review: A whimper, when smartwatches need a bang</p> */}
        </div>
        <img className="w-100 py-3" src="https://utouchdesign.com/themes/envato/altroznews/images/news/lifestyle/health5.jpg" alt="" />
        </div>
      </div>
    </div>
  )
