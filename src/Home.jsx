        ...
        <div className="row">
          ...
          <div className="col-lg-4 ">
            <div>
              ...
              <div className='style'>
                <h2 className='btn btn-danger fw-bold fs'>Lifestyle</h2>
                {/* <a className='text' href="Lifestyle"></a> */}
                <h2><a href="#">Samsung gear s3 review: A whimper, when smartwatches need a bang</a></h2>
              </div>
            </div>
            
            <div>
              <img className="w-100 py-3 n2" src="https://utouchdesign.com/themes/envato/altroznews/images/news/tech/game1.jpg" alt="" />
              <div className='head'>
                <h2 className='btn btn-danger fw-bold fs'>Games</h2>
                <h2><a href="Games">Historical heroes and robot dinosarus</a></h2>
              </div>
            </div>
          </div>
        </div>
